...
interface IKyber {
    ...
    function swapEtherToToken(ERC20 token, uint256 minRate) external returns (uint256);
...
contract Trader {
    ...
    function kyberSwap(
        ...
        uint256 destAmount = KYBER_PROXY.tradeWithHint(
            ERC20(sai),
            tokenQty,
    ...
    function buyKyberSellUniswap(
        ...
        uint256 _ethAmount = kyberSwap(KYBER_PROXY, ERC20(_fromToken), _amount, msg.sender);
...
contract ArbExample is DyDxFlashLoan, Trader {
    ...
    function callFunction(
        ...
        (address flashToken, uint256 flashAmount, uint256 balanceBefore) = abi.decode(
            data,
